...
# WHERE DEVICE_ID = '00158D000151B2131'
# AND COLLECT_DATE = '20190101'
# """
# df = get_table_from_db(sql, 'aihems_api_db')
device_address = '00158D000151B2131'
...
gs = sk.model_selection.GridSearchCV(estimator=model,               # 모델 정의
                                     param_grid=params,
                                     cv=5,
                                     scoring='accuracy',
                                     n_jobs=-1)
...
df.to_csv('C:/Users/user/Desktop/model_predict_result.csv',)
